        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        <Text style={{ color: COLORS.white, ...FONTS.h3}}>あなたのポートフォリオのバランス</Text>
                        <Text style={{ marginTop: SIZES.base, color: COLORS.white, ...FONTS.h1 }}>${dummyData.portfolio.balance}</Text>
                        <Text style={{ color: COLORS.white, ...FONTS.body5 }}>{dummyData.portfolio.changes} 過去24時間</Text>
                    ...
                    >
                        <Text
                            style={{
                                 marginLeft: SIZES.padding, color: COLORS.white, ...FONTS.h2
                            }}
                        >
                            Trending
                        </Text>
